...
import { Download, Smartphone, Laptop, Maximize, Minimize, ChevronDown, ChevronUp } from 'lucide-react'
...
export default function MockupScreenshotApp() {
  ...
  const handleScreenshot = useCallback(async () => {
    ...
    try {
      ...
      link.download = `${activeDevice}-mockup-${Date.now()}.png`
        ...
        <div className="grid lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 flex flex-col h-fit">
            <div className="relative">
              {/* Scroll Up Indicator */}
              {canScrollUp && (
                <div className="absolute top-0 left-0 right-0 h-8 bg-gradient-to-b from-white to-transparent z-10 flex items-start justify-center pt-1">
              ...
              <div
                ref={scrollRef}
                className="max-h-[70vh] overflow-y-auto pr-2 space-y-6 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100"
              ...
              >
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="website-scale">Website Scale: {websiteScale.toFixed(1)}x</Label>
                      <input
                        id="website-scale"
                        type="range"
                        min="0.5"
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {shadowEnabled && (
                      <>
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="shadow-opacity">Shadow Opacity: {Math.round(shadowOpacity * 100)}%</Label>
                          <input
                            id="shadow-opacity"
                            type="range"
                            min="0"
              ...
              {canScrollDown && (
                <div className="absolute bottom-0 left-0 right-0 h-8 bg-gradient-to-t from-white to-transparent z-10 flex items-end justify-center pb-1">
            ...
            <div className="mt-4">
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button onClick={handleScreenshot} className="w-full" size="lg">
              ...
              {activeDevice === "iphone" && (
                ...
                >
                  <Image
                    ...
                    width={300}
                    height={600}
                    className={`max-w-full h-auto ${isFullscreen ? 'max-h-[85vh]' : ''}`}
                    style={{
                    ...
                    priority
                  />
                  {/* Content overlay area for iPhone screen */}
                  <div
                    className="absolute top-[2.5%] left-[5.5%] right-[5.5%] bottom-[2.5%] overflow-hidden"
                    style={{
              ...
              {activeDevice === "macbook" && (
                ...
                >
                  <Image
                    ...
                    priority
                  />
                  {/* Content overlay area for MacBook screen */}
                  <div
